...
class WebhookTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.secret_key = os.getenv('WEBHOOK_SECRET', 'webhook')
        self.payload = {
            "id": "1dd2854e-3a79-4548-ae36-97e4a18ebf81",
            "amount": 100,
            "currency": "ETB",
            "created_at_time": 1673381836,
            "timestamp": int((datetime.utcnow() - timedelta(minutes=2)).timestamp()),
            "cause": "Testing",
    ...
    def test_verify_signature(self):
        ...
        received signatures.
        """
        expected_signature = self.generate_signature(self.payload, self.secret_key)
        self.assertTrue(verify_signature(self.payload, expected_signature, self.secret_key))
    ...
    def test_replay_attack_rejection(self):
        ...
        """
        self.payload['timestamp'] = int((datetime.utcnow() - timedelta(minutes=10)).timestamp())
        headers = {'YAYA-SIGNATURE': self.generate_signature(self.payload, self.secret_key)}
